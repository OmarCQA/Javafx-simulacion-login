 ...
 */
package com.omarcastillo.controller;

import com.omarcastillo.model.Rol;
import com.omarcastillo.model.Usuario;
...
public class AuthSistema {
    ...
    public AuthSistema(){
        ...
        Usuario usuarioUser =new Usuario("user", 
                    "user", "user", Rol.USER);
        Usuario userYo = new Usuario("Omar",
                    "123", "Omar Antonio", Rol.USER);
